...
const file_stats_api_proto_rawDesc = "" +
	...
	"\x06points\x18\x04 \x03(\v2&.qubic.stats.api.pb.SupplyHistoryPointR\x06points2\xc1\x04\n" +
	"\fStatsService\x12l\n" +
	...
	"\x0eGetAssetOwners\x12,.qubic.stats.api.pb.GetAssetOwnershipRequest\x1a-.qubic.stats.api.pb.GetAssetOwnershipResponse\"@\x82\xd3\xe4\x93\x02:\x128/v1/issuers/{issuer_identity}/assets/{asset_name}/owners\x12\x89\x01\n" +
	"\x10GetSupplyHistory\x12+.qubic.stats.api.pb.GetSupplyHistoryRequest\x1a,.qubic.stats.api.pb.GetSupplyHistoryResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/supply-historyB-Z+github.com/qubic/qubic-stats-api/protobuff/b\x06proto3"
